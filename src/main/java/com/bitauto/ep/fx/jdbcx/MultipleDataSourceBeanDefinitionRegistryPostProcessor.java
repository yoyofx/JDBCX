...
//  private static final Object DATASOURCE_TYPE_DEFAULT = "com.zaxxer.hikari.HikariDataSource";
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
        ...
        if (!dataSourceMap.isEmpty()) {
            String beanName = dataSourceMap.keySet().toArray()[0].toString();
    ...
    public void setEnvironment(Environment environment) {
         ...
         */
        String configname = environment.getProperty("spring.datasource");
        if(configname==null || configname.isEmpty()){
            configname = "project.datasource.";
        }
        //获取到前缀是"project.datasource." 的属性列表值.
        RelaxedPropertyResolver propertyResolver = new RelaxedPropertyResolver(environment, configname);
        //获取到所有数据源的名称.
        Map<String, Object> subProperties = propertyResolver.getSubProperties("");
        List<String> dsPrefixsArr = new ArrayList<>();
        Set<String> strings = subProperties.keySet();
